...
ResolveCache.prototype._getPkgRelease = function (pkgMeta) {
    ...
    // concate _release to avoid issues while fetching especially from
    // URL because etag updates which represents files are updated
    // but we don't update becuase we just check the version inside
    // the package directory
    // See: https://github.com/bower/bower/issues/1945
    release += pkgMeta._release ? ':' + pkgMeta._release : '';
    return release;
};
