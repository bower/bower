...
function link(logger, name, localName, options, config) {
    if (name) {
        return linkTo(logger, name, localName, options, config);
    } else {
...
function linkTo(logger, name, localName, options, config) {
    var src;
    var dst;
    var project;
    ...
    .then(function () {
        return project.update([localName], options);
    })
