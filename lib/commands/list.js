...
var optionTypes = { help: Boolean, paths: Boolean, map: Boolean, offline: Boolean, sources: Boolean, versions: Boolean };
...
var versionTree = function (packages, tree) {
  var result = {};
...
module.exports = function (options) {
  ...
  manager
    ...
    .on('list', function (packages) {
      ...
      if (!options.paths && !options.map && !options.versions) {
      ...
      if (options.paths) {
        tree = shallowTree(packages, tree);
      } else if (options.map) {
        tree = deepTree(packages, tree);
      } else if (options.versions) {
        tree = versionTree(packages, tree);
      }
