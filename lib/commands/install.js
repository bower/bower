...
var generateRequire = require('../util/require');
var help    = require('./help');

var optionTypes = { help: Boolean, save: Boolean, force: Boolean, require: Boolean };
var shorthand   = { 'h': ['--help'], 'S': ['--save'], 'f': ['--force'], 'r': ['--require'] };
...
module.exports = function (paths, options) {
  ...
  manager
    ...
    .on('install', function() {
      // execute our requirejs util
      if (options.require) {
        generateRequire(manager, paths);
      }
    })
    .resolve();
