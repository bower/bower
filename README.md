...
# Using a remote package that has Git tags available
...
current working directory and your package **must** be available at a Git
endpoint (e.g., GitHub). Then run:
...
The `.bowerrc` defines up to 5 keys:
...
The `component.json` defines up to 6 keys:

* `name` (required): The name of your package.
* `version`: A semantic version number (see [semver](http://semver.org/)).
* `main` [string|array]: Files you are distributing as part of the package.
